...
#     colors = plt.cm.tab10(np.linspace(0, 1, len(memory_columns)))
...
#         for j, column in enumerate(memory_columns):
#             ax.bar(bar_positions, step_data[column], bar_width, bottom=bottoms, color=colors[j], label=f'{column}' if i == 0 else "")
#             bottoms += step_data[column]

#     ax.set_xlabel('Baseline')
#     ax.set_ylabel('Memory Usage (bytes)')
#     ax.set_title('Clustered Stacked Bar Chart of Memory Usage by Baseline and Step')
#     ax.set_xticks(group_positions + (group_width - group_spacing) / 2 - bar_width / 2)
#     ax.set_xticklabels(baselines, rotation=45, ha='right')
#     ax.legend(title='Memory Metrics', bbox_to_anchor=(1.05, 1), loc='upper left')
#     plt.tight_layout()
...
#     group_width = bar_width * len(steps) + bar_spacing * (len(steps) - 1) + group_spacing
#     group_positions = np.arange(len(baselines)) * group_width
#     colors = plt.cm.Set3(np.linspace(0, 1, len(assembly_columns)))
...
#         for j, column in enumerate(assembly_columns):
#             ax.bar(bar_positions, step_data[column], bar_width, bottom=bottoms, color=colors[j], label=f'{column}' if i == 0 else "")
#             bottoms += step_data[column]

#     ax.set_xlabel('Baseline')
#     ax.set_ylabel('Number of Parts')
#     ax.set_title('Clustered Stacked Bar Chart of Assembly State by Baseline and Step')
#     ax.set_xticks(group_positions + (group_width - group_spacing) / 2 - bar_width / 2)
#     ax.set_xticklabels(baselines, rotation=45, ha='right')
#     ax.legend(title='Assembly State Metrics', bbox_to_anchor=(1.05, 1), loc='upper left')
#     plt.tight_layout()
...
#     group_width = bar_width * len(steps) + bar_spacing * (len(steps) - 1) + group_spacing
#     group_positions = np.arange(len(baselines)) * group_width
#     colors = plt.cm.Set3(np.linspace(0, 1, len(timer_columns)))
...
#         for j, column in enumerate(timer_columns):
#             ax.bar(bar_positions, step_data[column], bar_width, bottom=bottoms, color=colors[j], label=f'{column}' if i == 0 else "")
#             bottoms += step_data[column]

#     ax.set_xlabel('Baseline')
#     ax.set_ylabel('Time (seconds)')
#     ax.set_title('Clustered Stacked Bar Chart of Timer State by Baseline and Step')
#     ax.set_xticks(group_positions + (group_width - group_spacing) / 2 - bar_width / 2)
#     ax.set_xticklabels(baselines, rotation=45, ha='right')
#     ax.legend(title='Timer State Metrics', bbox_to_anchor=(1.05, 1), loc='upper left')
#     plt.tight_layout()
...
#     group_width = bar_width * len(steps) + bar_spacing * (len(steps) - 1) + group_spacing
#     group_positions = np.arange(len(baselines)) * group_width
#     colors = plt.cm.Set3(np.linspace(0, 1, len(network_columns)))
...
#         for j, column in enumerate(network_columns):
#             ax.bar(bar_positions, step_data[column], bar_width, bottom=bottoms, color=colors[j], label=f'{column}' if i == 0 else "")
#             bottoms += step_data[column]

#     ax.set_xlabel('Baseline')
#     ax.set_ylabel('Number of Calls')
#     ax.set_title('Clustered Stacked Bar Chart of Network State by Baseline and Step')
#     ax.set_xticks(group_positions + (group_width - group_spacing) / 2 - bar_width / 2)
#     ax.set_xticklabels(baselines, rotation=45, ha='right')
#     ax.legend(title='Network State Metrics', bbox_to_anchor=(1.05, 1), loc='upper left')
#     plt.tight_layout()
